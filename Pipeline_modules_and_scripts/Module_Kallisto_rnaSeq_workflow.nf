...
################################## Module Kallisto_alignment #######################################
    ...
    This module contains the process to execute the Kallisto pseudoaligner that makes a quantification of the transcripts from the fastq files and a bam file containing the pseudoalignments, this process takes as input the subdirectory generated by the CreateDir process (Module_OrderFiles_FastQC_rnaSeq_workflow.nf) and returns the directory where all the results are generated.
...
conda ("/home/nbarco/.conda/envs/ipx-kallisto")
